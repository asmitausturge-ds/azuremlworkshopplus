...
def main(args):
    ...
    preprocessed_train_dataframe.to_csv(
        args.preprocessed_train_data + "/car_price_train.csv",
        index=False,
        header=True,
    )
    ...
    preprocessed_validation_dataframe.to_csv(
        args.preprocessed_validation_data + "/car_price_validation.csv",
        index=False,
        header=True,
    )
    ...
    preprocessed_test_dataframe.to_csv(
        args.preprocessed_test_data + "/car_price_test.csv",
        index=False,
        header=True,
    )
